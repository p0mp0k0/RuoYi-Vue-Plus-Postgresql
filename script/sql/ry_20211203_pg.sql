...
SELECT pg_catalog.setval('sys_dept_dept_id_seq', 110, false);
...
(
    ...
    user_type   varchar(2)   default '00'::character varying,
...
-- 初始化-用户信息表数据
-- ----------------------------
insert into sys_user values(1,  103, 'admin', '若依', '00', 'ry@163.com', '15888888888', '1', '', '$2a$10$7JB720yubVSZvUI0rEqK/.VqGOZTH.ulu33dHOiBE8ByOhJIrdAu2', '0', '0', '127.0.0.1', current_timestamp, 'admin', current_timestamp, '', null, '管理员');
insert into sys_user values(2,  105, 'ry',    '若依', '00', 'ry@qq.com',  '15666666666', '1', '', '$2a$10$7JB720yubVSZvUI0rEqK/.VqGOZTH.ulu33dHOiBE8ByOhJIrdAu2', '0', '0', '127.0.0.1', current_timestamp, 'admin', current_timestamp, '', null, '测试员');

SELECT pg_catalog.setval('sys_user_user_id_seq', 3, false);
...
SELECT pg_catalog.setval('sys_post_post_id_seq', 5, false);
...
SELECT pg_catalog.setval('sys_role_role_id_seq', 3, false);
...
SELECT pg_catalog.setval('sys_menu_menu_id_seq', 1606, false);
...
create unique index sys_dict_type_dict_type_uindex
...
SELECT pg_catalog.setval('sys_dict_type_dict_id_seq', 11, false);
...
SELECT pg_catalog.setval('sys_dict_data_dict_code_seq', 29, false);
...
SELECT pg_catalog.setval('sys_config_config_id_seq', 12, false);
...
SELECT pg_catalog.setval('sys_notice_notice_id_seq', 3, false);
...
SELECT pg_catalog.setval('sys_oss_config_oss_config_id_seq', 5, false);

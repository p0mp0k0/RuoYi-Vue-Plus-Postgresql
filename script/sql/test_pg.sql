...
SELECT pg_catalog.setval('sys_role_role_id_seq', 5, false);
...
SELECT pg_catalog.setval('sys_user_user_id_seq', 5, false);
...
SELECT pg_catalog.setval('test_demo_id_seq', 14, false);
...
SELECT pg_catalog.setval('test_tree_id_seq', 14, false);

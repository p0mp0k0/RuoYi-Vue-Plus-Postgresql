...
基于RuoYi-Vue-Plus，数据库替换为Postgresql，并定期与RuoYi-Vue-Plus同步。
...
7. 增加两个Postgresql函数，对应GenTable和genTableColumn查询系统表数据，并修改Mapper xml中的sql语句## 修改RuoYi功能
8. 修改vm中的domain和sql语句
